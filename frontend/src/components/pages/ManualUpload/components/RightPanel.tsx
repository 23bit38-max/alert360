...
import type { DetectionResult, UploadStats } from '../types';
        ...
        <div className="flex flex-col h-full gap-6 select-none animate-fade-in pb-10">
            ...
            <div className="glass border-white/5 rounded-[32px] p-6 lg:p-8 premium-shadow relative overflow-hidden group shrink-0">
                ...
                <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-5 mb-8">
                    <p className="text-[11px] text-muted-foreground font-bold tracking-widest leading-relaxed uppercase opacity-70">
                        Initialize <span className="text-primary italic">YOLOv11</span> analysis sequence. System will intercept feed and auto-calculate tactical metrics.
                    </p>
                </div>
